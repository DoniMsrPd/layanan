...
<div class="element-wrapper">
    <div class="element-box">
        ...
        <form method="POST" action="{{ $data->action }}" enctype="multipart/form-data">
            @csrf
            @method( $data->method )
            <input type="hidden" class="form-control" name="id" id="id" value="{{ $data->typeAset->Id ??'' }}">
            <input type="hidden" class="form-control" name="jenisAsetId" id="jenisAsetId"
                value="{{ $data->jenisAset->Id ??'' }}">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group row">
                        <label class="col-form-label col-sm-3" for=""> Jenis Aset <sup
                                class="text-danger">*</sup></label>
                        <div class="col-sm-6"><input class=" form-control"
                                value="{{ $data->jenisAset->Nama ??'' }}" disabled>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6"><input class=" form-control" placeholder="Nama" required=""
                                value="{{ $data->typeAset->Nama ??'' }}" name="nama">
                        </div>
                    </div>
                </div>
            </div>
