...
@section('vendor-script')
  ...
  <script src="{{ asset('vendors/js/extensions/toastr.min.js') }}"></sript>
  <script src="{{ asset('vendors/js/extensions/moment.min.js') }}"></sript>
  <script src="{{ asset('vendors/js/tables/datatable/jquery.dataTables.min.js') }}"></sript>
  <script src="{{ asset('vendors/js/tables/datatable/datatables.buttons.min.js') }}"></sript>
  <script src="{{ asset('vendors/js/tables/datatable/dataTables.bootstrap5.min.js') }}"></sript>
  <script src="{{ asset('vendors/js/tables/datatable/dataTables.responsive.min.js') }}"></sript>
  <script src="{{ asset('vendors/js/tables/datatable/responsive.bootstrap5.js') }}"></sript>
@endsection
@section('page-script')
  <!-- Page js files -->
  <script src="{{ asset('js/scripts/pages/dashboard-analytics.js') }}"></sript>
  <script src="{{ asset('js/scripts/pages/app-invoice-list.js') }}"></sript>
@endsection
