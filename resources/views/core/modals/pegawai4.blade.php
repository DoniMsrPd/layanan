@push('scripts')
<style>
    table#pegawai-dt4 tbody td {
        padding: 2px
    }
</style>
<div class="modal fade" id="pegawai-modal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-body">
                <!-- <span id="type"></span> -->
                <table class="table table-bordered table-lg table-v2" id="pegawai-dt4" width="100%">
                    <thead>
                        <tr>
                            <!-- <th>No</th> -->
                            <!-- <th>NIP</th> -->
...
<script>
    var NipSelected;
    $(function() {
        var table1 = $('#pegawai-dt4').DataTable({
            processing: true,
            serverSide: true,
            deferLoading: 0,
            ...
            columns: [
                ...
                { data: 'pilih4', name: 'pilih4' , searchable:false, orderable:false, className: "text-center" }
            ],
        ...
        $(document).on("click",'.lookup-pegawai4',function () {
            $('#pegawai-dt4').DataTable().ajax.url("{!! route('core.pegawai.datatables') !!}").load();
