@push('scripts')
<style>
    table#pegawai-dt2 tbody td {
        padding: 2px
    }
</style>
<div class="modal fade" id="pegawai-modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-body">
                <!-- <span id="type"></span> -->
                <table class="table table-bordered table-lg table-v2" id="pegawai-dt2" width="100%">
                    <thead>
                        <tr>
                            <!-- <th>No</th> -->
                            <!-- <th>NIP</th> -->
...
<script>
    var NipSelected;
    $(function() {
        var table1 = $('#pegawai-dt2').DataTable({
            processing: true,
            serverSide: true,
            deferLoading: 0,
            ...
            columns: [
                ...
                { data: 'pilih2', name: 'pilih2' , searchable:false, orderable:false, className: "text-center" }
            ],
        ...
        $(document).on("click",'.lookup-pegawai2',function () {
            (typeof table !== 'undefined') ? NipSelected = table.rows().ids().toArray():'';
            $('#pegawai-dt2').DataTable().ajax.url("{!! route('core.pegawai.datatables') !!}").load();
