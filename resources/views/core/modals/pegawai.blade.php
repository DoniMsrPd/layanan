...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-body">
                <!-- <span id="type"></span> -->
                <table class="table table-bordered table-lg table-v2" id="pegawai-dt" width="100%">
                    <thead>
                        <tr>
                            <!-- <th>No</th> -->
                            <!-- <th>NIP</th> -->
...
<script>
    var NipSelected;
    $(function() {
        var table1 = $('#pegawai-dt').DataTable({
            processing: true,
            serverSide: true,
            deferLoading: 0,
        ...
        $(document).on("click",'.lookup-pegawai',function () {
            (typeof table !== 'undefined') ? NipSelected = table.rows().ids().toArray():'';
            $('#pegawai-dt').DataTable().ajax.url("{!! route('core.pegawai.datatables') !!}").load();
