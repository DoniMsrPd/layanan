            ...
            <tr>
                <td>
                    ...
                    <div class="col-md-6 mb-1">
                        <a class="btn btn-sm btn-primary" style=" float: right;" href="{{ route('layanan.create-tiket') }}">Pembuatan
                            Layanan</a>
                    </div>
                    @endcan
                </td>
                <td>
                    @can('layanan.create')
                    <div class="col-md-6 mb-1">
                    <a class="btn btn-sm btn-success" style=" float: right;" href="{{ route('layanan.create') }}">Permintaan
                        Layanan</a>
                    </div>
                    @endcan
                </td>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row"><label class="col-form-label col-sm-4" for=""> Group
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control select2 form-filters" multiple="true"
                                            id="groupSolver" name="groupSolver[]">
                                ...
                                @if(request()->pending<>1)
                                    ...
                                    <div class="form-group row"><label class="col-form-label col-sm-4" for=""> Tgl
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="TglStart" value="" name="tglStart"
                                                class="form-control datetimepick form-filters"
                                    ...
                                    <div class="form-group row"><label class="col-form-label col-sm-4" for=""> </label>
                                        <div class="col-sm-8">
                                            <input value="{{ request()->q }}" placeholder="Cari Layanan ...." id="cari"
                                                autofocus="true"
                                                class="form-control form-control-sm rounded bright form-filters"
                                                name="q">
                                        </div>
                                    </div>
                            </div>
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2 form-filters" multiple="true" id="sla"
                                                ...
                                                <option @if(is_array(request()->sla) &&
                                                    in_array('melewati',request()->sla)
                                                    ||
                                                    'melewati'==request()->sla) selected @endif
                                                    value="melewati">Melewati
                                                </option>
                                                <option @if(is_array(request()->sla) &&
                ...
                <tr>
                    <td colspan="3" >
                        ...
                        <input value="{{ request()->q }}" placeholder="Cari Layanan ...." id="cari" autofocus="true"
                            class="mb-1 form-control form-control-sm rounded bright form-filters" name="q">
                    </td>
                </tr>
                <tr>
                    <td style="width: 120px">
                        <input type="text" id="TglStart"  name="tglStart"
                            class="form-control flatpickr form-filters" placeholder="Tanggal Awal"
                            value="{{ request()->tglStart ?? date('Y').'-01-01' }}">
                    </td>
                    <td>
                        <center>-</center>
                    ...
                    <td style="width: 120px">
                        <input type="text" id="TglEnd" name="tglEnd"
                            class="form-control flatpickr form-filters" placeholder="Tanggal Akhir"
                            value="{{ request()->tglEnd ?? date('Y-m-d') . ' 23:59:59' }}">
                    </td>
                </tr>
            </table>
...
<div id="hasilpencarian">
    ...
    <div class="load-more-tickets" style="width:50%; margin: 0 auto;">
        ...
        <ul class="pagination">
            ...
            @else
            <li class="page-item">
                <a class="page-link" href="{{ $data->layanan->appends(request()->all())->previousPageUrl() }}"
                    rel="prev" aria-label="« Previous">‹</a>
            </li>
            @endif


            <li class="page-item disabled"><a class="page-link" href="#">{{ "Page " . $data->layanan->currentPage() . "
                    of " . $data->layanan->lastPage() }}</a></li>
            ...
            <li class="page-item">
                <a class="page-link" href="{{ $data->layanan->appends(request()->all())->nextPageUrl() }}"
                    rel="next">></a>
            </li>
            @else
...
<script>
    $(function() {
        ...
        // $('#tglStart').flatpickr({
        //     dateFormat: 'd M Y',
        //     defaultDate: new Date("{{ request()->tglStart ?? date('Y').'-01-01'}}")
        // });
        // $('#tglEnd').flatpickr({
        //     dateFormat: 'd M Y',
        //     defaultDate: new Date("{{ request()->tglEnd ?? date('Y-m-d') . ' 23:59:59' }}")
        // });
        // $('#TglStart').flatpickr({ dateFormat: 'd M Y'}).flatpickr("defaultDate", new Date("{{ request()->tglStart ?? date('Y').'-01-01'}}"));
        // $('#TglEnd').flatpickr({ dateFormat: 'd M Y'}).flatpickr("defaultDate", new Date("{{ request()->tglEnd ?? date('Y-m-d') . ' 23:59:59' }}"));
        var minlength = 3;
