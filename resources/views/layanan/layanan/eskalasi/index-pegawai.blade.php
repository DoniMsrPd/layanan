    ...
    <div class="element-box">
        ...
        <h5 class="form-header">
            ...
            <span class="btn-group" role="group" style=" float: right;">
                ...
                @endcan
                @can('layanan.create')
                <a class="btn btn-success" style=" float: right;" href="{{ route('layanan.create') }}">Permintaan
                    Layanan</a>
                @endcan
            </span>
            @endif
                ...
                <div class="col-sm-4">
                    ...
                    @if(request()->pending<>1)
                        ...
                        <div class="form-buttons-w"><button class="btn btn-primary apply"> Apply</button><a
                                href="{{ route('layanan.index') }}" class="btn btn-danger clear"> Clear</a></div>
                </div>
                @if(request()->pending<>1)
                    <div class="col-sm-4">
        ...
        <div id="hasilpencarian">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    {!! $statusLayanan !!}   &nbsp; &nbsp;:: &nbsp; &nbsp;  {!! $NoTicket !!}   <span style="float: right;color: grey">{{
                        pegawaiBiasa() ?
                ...
                <div class="card-body" style="padding-top: 5px;border-top: 1px solid rgba(0,0,0,.125);">
                    <div class="ur-kegitan">
                        <table width="100%">
                            @foreach ($layanan->tl as $tl)
                            <tr>
                                <td style="padding: 5px" valign="top"> <span style="color: grey"> {{ ToDmyHi($tl->CreatedAt) }}</span> <br>
                                    <div style="padding-left: 20px">{!! $tl->Keterangan !!}</div>
                                        ...
                                        <ul class="pt-1 mb-0 list-file" style="padding: 20px; width: 50%;">
                                            ...
                                            <li>
                                                ...
                                                <span style="cursor: pointer;" data-id="{{ $file->Id }}" data-title="{{ $file->NmFileOriginal }}"
                                                    data-url="/core/storage/{{ $file->Id }}" class="text-danger deleteData float-right"><i
                            ...
                            @endphp
                            @if ($day == 0 && $layanan->StatusLayanan ==4)
                                <tr>
                                    <td><a class="btn btn-primary selesaikan" style=" float: right;color:white" data-url="{{ route('layanan-tl.selesaikan',$layanan->Id) }}">Selesaikan Layanan Ini</a></td>
                                </tr>
                            @endif
...
<div class="modal fade" id="news" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-lgg" role="document"
